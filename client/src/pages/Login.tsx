            ...
            <div className="max-w-md mx-auto mt-12 bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                <div className="p-6">
                    <h1 className="text-2xl font-bold text-center mb-6">
                        Bienvenue sur TopTrack Explorer
                    </h1>

                    <p className="text-gray-300 mb-8 text-center">
                        Découvrez vos morceaux et artistes préférés basés sur votre historique d'écoute Spotify.
                    </p>
                ...
                <div className="px-6 py-4 bg-gray-700 text-sm text-gray-400">
                    <p className="text-center">
                        Cette application utilise l'API Spotify pour récupérer vos données d'écoute.
                        Nous ne stockons aucune de vos données personnelles.
                    </p>
                </div>
            </div>
        </Layout>
